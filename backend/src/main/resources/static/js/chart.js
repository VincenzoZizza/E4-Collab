(() => {
    if (window.chart == null) {
        ...
        chart.createAreaChart = function (data, svgElement, tooltipContainerElement = [], tooltipLabelElement = [], domainX = [], domainY = []) {
        ...
        chart.createPieChart = function (data, svgElement, tooltipContainerElement = null, tooltipLabelElement = null) {
            const prepareSvgElements = () => {
                const svg = d3.select(svgElement);
                const chartGroup = svg.append("g");
        ...
        chart.createSessionChart = function (sensorsData, tagsTimestamps, svgElement, tooltipsContainersElements = null, tooltipsLabelsElements = null, domainX = [], domainsY = null, roundIntervalsInSeconds = null, curveFunctions = null, pathsTitles = null, pathsColors = null, ticksColors = null, tagsColor = null) {
            const prepareSvgElements = () => {
