(() => {
    if (window.utils == null) {
        window.utils = {}
        utils.getDateRange = function (timestamp, mode, prevNext) {
            const range = {}
        ...
        utils.compareDates = function (timestampA, timestampB, mode) {
        ...
        utils.formatDateUTC = function (date, timeOnly) {
        ...
        utils.formatDuration = function (duration, decimalPlaces = 0) {
        ...
        utils.getLast12MonthsRange = function () {
        ...
        utils.createActionButton = function (buttonClasses, iconClasses, textContent, onClick, tooltip) {
        ...
        utils.isHTMLElementVisible = function (htmlElement) {
            if (!htmlElement) {
                return false;
            }
        ...
        utils.getClosestNonVisibleParent = function (htmlElement) {
            if (!htmlElement) {
                return null;
            }
        ...
        utils.ensureHTMLElementVisible = function (htmlElement) {
